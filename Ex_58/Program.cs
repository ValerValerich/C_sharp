...
int a2 = b1; // перемножить матрицы можно только если количество столбцов первой совпадает с количеством строк второй
...
// Можно ли развернуть вторую матрицу и идти по строкам, ограничиваясь двумя циклами? 